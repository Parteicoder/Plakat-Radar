    ...
    Box(Modifier.fillMaxSize()) {
        Column(
            ...
            when (mode) {
                ...
                "member" -> {
                    Text("Bitte zuerst deinen Namen eintragen. Danach öffnet sich die Kamera zum Scannen des Team-QR-Codes.")
                    OutlinedTextField(myName, { myName = it }, label = { Text("Dein Name") }, modifier = Modifier.fillMaxWidth())
...
print("start screen keeps member name before QR scanner")
